...
void Machine_angle_init()
{
	
	{
		...
		Machine_angle[Joint_2].Machine_angle_l.normal_angle= 1.22*6.33;//2.355*6.33
		Machine_angle[Actuator_yaw].Machine_angle_l.normal_angle=348;
		Machine_angle[Actuator_roll].Machine_angle_l.normal_angle=0;
		Machine_angle[Actuator_pitch].Machine_angle_l.normal_angle=0;
	}
	{
		Machine_angle[Upraise_clamp].Machine_angle_l.exchange_angle=0;
		Machine_angle[Upraise].Machine_angle_l.exchange_angle=1400;
		Machine_angle[Clamp_sild].Machine_angle_l.exchange_angle=0;		
		...
		Machine_angle[Joint_1].Machine_angle_l.exchange_angle=0.31*6.33;
		Machine_angle[Joint_2].Machine_angle_l.exchange_angle=1.533*6.33;
		Machine_angle[Actuator_yaw].Machine_angle_l.exchange_angle=0;
	...
	}
	{
		...
		Machine_angle[Joint_1].Machine_angle_l.store_angle=-1.538*6.33;    //-1.935
	...
	{
		Machine_angle[Upraise_clamp].Machine_angle_l.bigisland_straight_angle=-2;
		Machine_angle[Upraise].Machine_angle_l.bigisland_straight_angle=-400;		
		Machine_angle[Clamp_sild].Machine_angle_l.bigisland_straight_angle=5.6;
		...
		Machine_angle[Joint_1].Machine_angle_l.bigisland_straight_angle=-0.4*6.33;
		Machine_angle[Joint_2].Machine_angle_l.bigisland_straight_angle=0;
		Machine_angle[Actuator_yaw].Machine_angle_l.bigisland_straight_angle=164;
		Machine_angle[Actuator_roll].Machine_angle_l.bigisland_straight_angle=0;
		Machine_angle[Actuator_pitch].Machine_angle_l.bigisland_straight_angle=-35;
	}
	{
		Machine_angle[Upraise_clamp].Machine_angle_l.bigisland_slanted_angle=200;
		Machine_angle[Upraise].Machine_angle_l.bigisland_slanted_angle=30;		
		...
		Machine_angle[Actuator_roll].Machine_angle_l.bigisland_slanted_angle=90;
		Machine_angle[Actuator_pitch].Machine_angle_l.bigisland_slanted_angle=90;
	}
	{
		...
		Machine_angle[Joint_2].Machine_angle_l.smallisland_angle=0;
		...
		Machine_angle[Actuator_pitch].Machine_angle_l.smallisland_angle=-40;
	}
	{
...
//	config_full_mapping_one(Clamp_roll,CLAMP_ROLL,1);
	...
	config_full_mapping_one(Actuator_yaw,joint_3_yaw,1);
