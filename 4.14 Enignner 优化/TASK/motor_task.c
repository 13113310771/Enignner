...
void Machine_angle_init()
{
	
	{
		...
		Machine_angle[P_T_pitch].Machine_angle_l.normal_angle=0;
		Machine_angle[P_T_yaw].Machine_angle_l.normal_angle=0;
	...
	}
	{
		...
		Machine_angle[Actuator_yaw].Machine_angle_l.smallisland_angle=-90;
	    ...
	    Machine_angle[P_T_pitch].Machine_angle_l.smallisland_angle=0;
		Machine_angle[P_T_yaw].Machine_angle_l.smallisland_angle=0;				
	}
	{
...
{
		Motor[P_T_Pitch].Brushless.angle_ref=100;
		Motor[P_T_Yaw].Brushless.angle_ref=100;
}
