...
void DMA1_Stream1_IRQHandler(void)
{
		 ...
		 && DMA_GetITStatus(DMA1_Stream1,DMA_IT_HTIF1) != RESET)
	{
		...
		dma_buffer_to_unpack_buffer(&judge_rx_obj,UART_DMA_HALF_IT);
...
void DMA1_Stream6_IRQHandler(void)
{
	...
	{
		dma_buffer_to_unpack_buffer(&control_rx_obj,UART_DMA_FULL_IT);
		 ...
		 && DMA_GetITStatus(DMA1_Stream6,DMA_IT_HTIF6) != RESET)
	{
		...
		dma_buffer_to_unpack_buffer(&control_rx_obj,UART_DMA_HALF_IT);
...
void UART8_IRQHandler(void)
{
	...
	{
		dma_buffer_to_unpack_buffer(&control_rx_obj, UART_IDLE_IT);
