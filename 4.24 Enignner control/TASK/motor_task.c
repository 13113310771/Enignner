...
void Machine_angle_init()
{
	...
	}
	{
		...
		Machine_angle[Clamp_sild].Machine_angle_l.exchange_pick_angle=10;
		...
		Machine_angle[Joint_1].Machine_angle_l.exchange_pick_angle=-1.179*6.33;
		Machine_angle[Joint_2].Machine_angle_l.exchange_pick_angle=1.454*6.33;
		Machine_angle[Actuator_yaw].Machine_angle_l.exchange_pick_angle=-130;
...
{
		Motor[P_T_Pitch].Servo.angle_ref=220;//135基准   //NORMAL
